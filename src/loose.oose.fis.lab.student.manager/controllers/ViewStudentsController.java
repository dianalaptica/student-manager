...
public class ViewStudentsController {
    ...
    public void initialize() {
        studentLastNameColumn.setCellValueFactory(new
                PropertyValueFactory<>("lastName"));
        studentFirstNameColumn.setCellValueFactory(new
                PropertyValueFactory<>("firstName"));
        studentAgeColumn.setCellValueFactory(new
                PropertyValueFactory<>("age"));
        studentMeanGradeColumn.setCellValueFactory(new
                PropertyValueFactory<>("meanGrade"));
